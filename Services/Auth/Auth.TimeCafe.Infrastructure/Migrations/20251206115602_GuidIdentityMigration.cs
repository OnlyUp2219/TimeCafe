...
{
    /// <inheritdoc />
    public partial class GuidIdentityMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Drop FK constraints that depend on text columns before type change
            ...
            // PostgreSQL requires explicit USING clause when changing text -> uuid
            ...
            // Recreate FK with updated uuid types
