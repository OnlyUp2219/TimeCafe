...
namespace Venue.TimeCafe.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260618110239_AddPayFromBalanceToVisit")]
    partial class AddPayFromBalanceToVisit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Venue.TimeCafe.Domain.Models.Tariff", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("AudienceTags")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.Property<int?>("MinSessionMinutes")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Venue.TimeCafe.Domain.Models.Visit", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("FinishRequestedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<bool>("PayFromBalance")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
