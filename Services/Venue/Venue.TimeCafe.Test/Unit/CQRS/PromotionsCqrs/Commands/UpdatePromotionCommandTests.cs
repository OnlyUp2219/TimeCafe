...
public class UpdatePromotionCommandTests : BaseCqrsHandlerTest
{
    ...
    {
        _handler = new UpdatePromotionCommandHandler(UowMock.Object, PublisherMock.Object);
    }
    ...
    [InlineData("99999999-9999-9999-9999-999999999999", "Name", null, 10.0, true, false, "Описание обязательно")]
