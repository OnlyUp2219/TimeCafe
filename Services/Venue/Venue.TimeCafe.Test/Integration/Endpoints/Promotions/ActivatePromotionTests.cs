...
{
    [Fact]
    public async Task Endpoint_ActivatePromotion_Should_Return204_WhenPromotionExists()
    {
    ...
    public async Task Endpoint_ActivatePromotion_Should_ActuallyActivatePromotion_WhenCalled()
    {
        ...
        var activateResponse = await Client.PostAsync($"/venue/promotions/{promotion.PromotionId}/activate", null);
