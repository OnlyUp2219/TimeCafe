...
namespace TimeCafe.UI.Utilities.Helpers;
...
internal class TitleBarHelper
{
    ...
    public static void UpdateTitleBar(ElementTheme theme)
    {
        if (App.MainWindow.ExtendsContentIntoTitleBar)
        {
            ...
            if (theme == ElementTheme.Default)
            {
                theme = Microsoft.UI.Xaml.Application.Current.RequestedTheme == ApplicationTheme.Light ? ElementTheme.Light : ElementTheme.Dark;
            }
