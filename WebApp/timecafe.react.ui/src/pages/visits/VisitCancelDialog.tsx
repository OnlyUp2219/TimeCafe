                            ...
                            <Card>
                                <div className="flex flex-col gap-3 text-sm">
                                    <div className="flex items-center justify-between gap-3">
                                        <span className="text-[var(--colorNeutralForeground3)]">Тариф:</span>
                                        <span className="font-semibold">{visit.tariffName}</span>
                                    </div>
                                    <div className="flex items-center justify-between gap-3">
                                        <span className="text-[var(--colorNeutralForeground3)]">Время запроса:</span>
                                        <span className="font-medium">{formatDateTime(visit.entryTime)}</span>
                                    </div>
                                    <div className="flex items-center justify-between gap-3">
                                        <span className="text-[var(--colorNeutralForeground3)]">Количество гостей:</span>
                                    ...
                                    {visit.plannedMinutes && (
                                        <div className="flex items-center justify-between gap-3">
                                            <span className="text-[var(--colorNeutralForeground3)]">Запланировано:</span>
                                            <span className="font-medium">
