    ...
    return (
        <HoverTiltCard className="flex flex-col justify-start gap-4 lg:col-span-5 min-h-[320px]" size={sizes.card}>
            <div className="flex flex-col gap-4">
                <div className="flex items-center gap-2 flex-wrap justify-between">
                    <div className="flex items-center gap-2">
                        <Flash20Regular className="text-(--colorStatusWarningForeground1)" />
            ...
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                ...
                <Button appearance="outline" size={sizes.button} icon={<ShieldKeyhole20Regular className="text-(--colorBrandForeground1)" />} onClick={onNavigateProfile}>
                    <Text truncate wrap={false}>Безопасность</Text>
                </Button>
                <Button appearance="outline" size={sizes.button} icon={<Money20Regular className="text-(--colorStatusSuccessForeground1)" />} onClick={onNavigateBilling}>
                    <Text truncate wrap={false}>Баланс</Text>
                </Button>
                <Button appearance="outline" size={sizes.button} icon={<History20Regular className="text-(--colorBrandForeground1)" />} onClick={onNavigateBilling}>
