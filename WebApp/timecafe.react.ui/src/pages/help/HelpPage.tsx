                        ...
                        <AccordionPanel collapseMotion={{ duration: 250, easing: motionTokens.curveDecelerateMid } as any}>
                            <div className="flex flex-col gap-4">
                                ...
                                <ol className="list-decimal ml-6 flex flex-col gap-2">
                                    ...
                                    <li>Выберите одну из предустановленных сумм (например, 5, 10, 20, 50 бел. руб.) или введите произвольную сумму.</li>
                        ...
                        <AccordionPanel collapseMotion={{ duration: 250, easing: motionTokens.curveDecelerateMid } as any}>
                            <div className="flex flex-col gap-4">
                                ...
                                <ul className="list-disc ml-6 flex flex-col gap-2">
                                    ...
                                    <li><Body1Strong>Стоп-чек (Максимальный лимит):</Body1Strong> Ограничивает предельную стоимость визита за день. Например, если стоп-чек равен 20 бел. руб., то сколько бы часов вы ни провели в заведении в рамках суток, итоговая стоимость не превысит 20 бел. руб.</li>
                                </ul>
                            </div>
                        </AccordionPanel>
                    </AccordionItem>
